// ============================================================================
// SINGLE-FILE CLOUDFLARE WORKER FOR URL SHORTENER
// ============================================================================
// Copy this entire file and paste it into the Cloudflare Workers dashboard
// ============================================================================

// Admin HTML (embedded as string)
...
<head>
    ...
    <style>
        * {
        ...
        .auth-section.active, .admin-section.active {
            display: block;
        }
        .form-group {
            margin-bottom: 20px;
    ...
    <script>
        ...
        document.getElementById('createForm').addEventListener('submit', async (e) => {
            ...
            try {
                ...
                if (response.ok) {
                    showMessage('message', \`Short URL created: \${data.shortCode}\`, 'success');
        ...
        async function loadUrls() {
            try {
                ...
                // Switch to admin view if not already there
                document.getElementById('authSection').classList.remove('active');
                document.getElementById('adminSection').classList.add('active');
            } catch (error) {
